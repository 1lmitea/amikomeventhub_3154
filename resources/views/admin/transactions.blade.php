...
@section('content')
    ...
    <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden mt-6">
        <div class="px-8 py-6 bg-slate-50/50 border-b flex flex-wrap gap-4 items-center justify-between">
            <div>
                <h1 class="text-2xl font-black">Laporan Transaksi</h1>
                <p class="text-slate-500 font-medium text-sm mt-1">Pantau arus kas dan penjualan tiket Anda.</p>
            </div>
            <div class="flex gap-4">
                <button
                    class="px-4 py-2 border-2 border-slate-200 rounded-xl font-bold hover:bg-white hover:border-indigo-600 hover:text-indigo-600 transition text-sm">
                    Ekspor Excel
                </button>
                <button
                    class="px-4 py-2 bg-indigo-600 text-white rounded-xl font-bold shadow-lg hover:bg-indigo-700 transition text-sm">
                    Unduh PDF
                </button>
            </div>
        </div>

        <div class="px-8 py-4 bg-slate-50/50 border-b flex flex-wrap gap-4 items-center">
