        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <img src="{{ asset('storage/' . $event->poster_path) }}" alt="Poster" class="w-16 h-20 rounded-xl object-cover shadow-sm border border-slate-200">
                     @else
                    <img src="https://placehold.co/16x20?text=No+Image" class="w-16 h-20 rounded-xl object-cover shadow-sm">
                    @endif
                    </td>
                    <td class="px-8 py-6">
